...
ui <- fluidPage(
  ...
  dashboardPage(
    ...
    dashboardBody(
      fluidRow(
        box(title = "Customer Demographic Size", width = NULL, solidHeader = TRUE, status = "primary", color = "#286192",
            fluidRow(
              box(align = "center",
                  title = NULL, 
                  width = 18,
...
server <- function(input, output) {
  ...
  ### For Demographic Spending - Billing - Contract Type
  ...
  ### Demographic Spending - Billing - Payment Methods
  ...
  ### Demographic Spending - Billing - Paperless Billing
  ...
  ### Entertainment Services - Internet Service
  ...
  ### Entertainment Services - Phone Service
  ...
  ### Entertainment Services - Streaming Service
